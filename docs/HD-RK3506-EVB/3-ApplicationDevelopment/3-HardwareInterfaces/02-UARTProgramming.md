...
串口范例2代码可用的测试方法如下：  
1\. 把示例代码在Linux主机上作本地编译，生成test\_uart\_2程序文件；  
2\. 使用另外一台Windows电脑和Linux主机建立串口连接；  
3\. 在Windows电脑打开串口助手软件，设置串口属性为“115200，8n1,无流控”；  
4\. 在Linux主机运行uart\_test\_2程序：
...
5\. 在串口助手的发送“hello vanxoak”的字符串。这时Linux主机的`uart_test_2`程序打印“hello vanxoak”的字符串。
