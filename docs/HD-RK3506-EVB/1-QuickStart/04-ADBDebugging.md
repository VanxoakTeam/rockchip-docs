...
<img src={require('./images/04-adbdebugging-01.png').default} alt="USB供电烧录.png" style={{display: 'block', margin: '20px auto', maxWidth: '80%', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)'}}/>
